...
Header.Search = function HeaderSearch({ searchTerm, setSearchTerm, ...restProps }) {
  ...
  return (
    <Search {...restProps}>
      ...
      <SearchInput value={searchTerm} onChange={({ target }) => setSearchTerm(target.value)} placeholder="Search films and series" active={searchActive} disabled={true} data-testid="search-input" />
    </Search>
  );
};
